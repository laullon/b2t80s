...
func NewZXPlus3() machines.Machine {
	...
	zx.cpu.RegisterPort(emulator.PortMask{Mask: 0x8002, Value: 0x0000}, mem)
	zx.cpu.RegisterPort(emulator.PortMask{Mask: 0x8002, Value: 0x4000}, mem)
	zx.cpu.RegisterPort(emulator.PortMask{Mask: 0xC002, Value: 0x0000}, fdc)
